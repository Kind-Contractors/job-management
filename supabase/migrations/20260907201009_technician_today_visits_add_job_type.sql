...
-- Stripped in the immediately following migration
-- (20260907201017_technician_today_visits_tighten_grants.sql), once it was
-- confirmed live that the plain REVOKE ALL ... FROM PUBLIC below does not
-- by itself remove anon's separately-granted EXECUTE.
